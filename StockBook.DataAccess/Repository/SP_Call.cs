...
namespace StockBook.DataAccess.Repository
{
    public class SP_Call : ISP_Call
    {
        ...
        private static string ConnetctionString = "";

        public SP_Call(ApplicationDbContext db)
        {
            _db = db;
            ConnetctionString = _db.Database.GetDbConnection().ConnectionString;
        }
        ...
        {
           using(SqlConnection sqlConnection = new SqlConnection(ConnetctionString))
            {
                sqlConnection.Open();
